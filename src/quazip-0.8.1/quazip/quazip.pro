...
#win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x86/ZlibDllRelease/ -lzlibwapi
#else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x86/ZlibDllRelease/ -lzlibwapid
#else:unix: LIBS += -L$$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x86/ZlibDllRelease/ -lzlibwapi

#INCLUDEPATH += $$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x86/ZlibDllRelease
#DEPENDPATH += $$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x86/ZlibDllRelease

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x64/ZlibDllRelease/ -lzlibwapi
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x64/ZlibDllRelease/ -lzlibwapid
else:unix: LIBS += -L$$PWD/../../zlib-1.2.11/contrib/vstudio/vc14/x64/ZlibDllRelease/ -lzlibwapi
